...
```{r Data Pull, echo=FALSE, warning=FALSE}
...
``` {r examining seasonality, echo=FALSE, warning=FALSE}
...
``` {r examining just the section above 1979, echo=FALSE, warning=FALSE}
...
``` {r detrending the data, echo=FALSE, warning=FALSE}
# detrending the data
...
``` {r detrending - differencing, echo=FALSE, warning=FALSE}
...
```{r Compare Linear Model, echo=FALSE, warning=FALSE}
set.seed(44)
...
```{r Compare ARIMA Model, echo=FALSE, warning=FALSE}
set.seed(44)
colnames(co2_1998_plus)[2] <- "co2_ppm"
...
```{r Evaluate the performance of 1997 linear and ARIMA models, echo=FALSE, warning=FALSE}
co2_tsb <- co2 %>% as_tsibble()
colnames(co2_tsb)[2] <- "co2_ppm"
...
```{r 2.5 data, echo=FALSE, warning=FALSE}
...
```{r 2.5 model, echo=FALSE, warning=FALSE}
##Seasonally adjust the weekly nOAA data 
##lagging at 12 for annual seasonal, can change to other number for annual "seasons"
season_num <- 12
co2_present$seasonally_adjusted_co2 <- difference(co2_present$CO2_avg, lag=season_num)
...
```{r 2.5 ARIMA, echo=FALSE, warning=FALSE}
...
```{r SA model with best AIC ARIMA, echo=FALSE, warning=FALSE}
...
```{r mse 2.5, echo=FALSE, warning=FALSE}
...
```{r polynomial, echo=FALSE, warning=FALSE}
...
```{r quad, echo=FALSE, warning=FALSE}
