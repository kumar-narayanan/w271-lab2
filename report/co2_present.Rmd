...
fit <- co2_tsb %>% model(ARIMA(co2_ppm ~ 0 + pdq(6,1,3) + PDQ(1,1,1), 
...
The Keeling curve is linearly increasing year of year till to date. Looking at the
Error terms The trend and the seasonality are captured reasonably well in the model.
...
The SARIMA model predicts the $co_2$ level to cross 420 ppm on ???.
The real data collected also crossed 420 ppm on April 2022. Our models predicts 
accurately.
...
linear model is close to 0 across many error metrics. ???
...
rownames(myData) <- c("Linear 420 FIRST", "SARIMA 420", "Recent SARIMA 420", 
                      "Linear 500", "SARIMA 500", "Recent SARIMA 500",
                      "Linear 420 LAST", "SARIMA 420", "Recent SARIMA 420", 
                      "Linear 500", "SARIMA 500", "Recent SARIMA 500", "Jan 2122")
myData[1] <- "Apr 2022"
myData[14] <- "Mar 2023"
myData[25] <- "Mar 2022"
myData[38] <- "Apr 2023"
...
Based on the time innovations to solve $CO_2$ problem and the increase in 
